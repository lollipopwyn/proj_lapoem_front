...
export const GET_BOOK_DETAIL_API_URL = (bookId) => `${BASE_URL}/book-list/${bookId}`; //도서 상세 페이지
export const GET_BOOK_REVIEWS_API_URL = (bookId) => `${BASE_URL}/book-list/${bookId}/reviews`; //도서 리뷰
...
export const GET_CHECK_THREAD_EXISTENCE_API_URL = (bookId) => `${BASE_URL}/threads/exists/${bookId}`; // 특정 책에 대한 스레드 존재 여부 확인
export const GET_SEARCH_THREADS_API_URL = `${BASE_URL}/search-threads`;
export const GET_THREADS_DETAIL_API_URL = (thread_num) => `${BASE_URL}/threads/${thread_num}`; // 스레드 상세 정보 조회 API URL
export const GET_THREADS_COMMENTS_API_URL = (thread_num) => `${BASE_URL}/threads/${thread_num}/comments`; // 스레드 댓글 목록 조회 API URL

//마이페이지
export const GET_MEMBER_INFO_API_URL = (memberNum) => `${BASE_URL}/members/${memberNum}`;
export const UPDATE_MEMBER_INFO_API_URL = (memberNum) => `${BASE_URL}/members/${memberNum}`;
...
export const POST_THREAD_COMMENT_API_URL = (thread_num) => `${BASE_URL}/threads/${thread_num}/comment`; // 스레드 댓글 작성 API URL
...
export const DELETE_THREAD_COMMENTS_API_URL = (commentId) => `${BASE_URL}/threads/comment/${commentId}`; // 스레드 댓글 및 대댓글 삭제 API URL
...
// 채팅방 목록 조회 URL
export const API_CHAT_LIST_URL = (memberNum) => `${FASTAPI_HTTP_BASE_URL}/chat-list/${memberNum}`;
